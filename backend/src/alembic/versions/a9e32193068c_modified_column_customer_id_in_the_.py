"""modified column customer_id in the appointments table.

Revision ID: a9e32193068c
Revises: 8cb2a49f073d
Create Date: 2025-10-26 02:17:54.118736
...
revision: str = 'a9e32193068c'
down_revision: Union[str, Sequence[str], None] = '8cb2a49f073d'
...
def downgrade() -> None:
    ...
    sa.Column('chat_code', sa.VARCHAR(), nullable=False),
